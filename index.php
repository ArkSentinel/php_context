...
<head>
    ...
    /* Ajustes para que el carrusel sea más grande y estético */
    .carousel-container {
        padding: 40px 0;
    }
    ...
    /* Personalización de flechas para que se vean en el fondo oscuro */
    .carousel-control-prev,
    .carousel-control-next {
        width: 5%;
        filter: invert(1) grayscale(100) brightness(2);
        /* Hace las flechas más blancas y brillantes */
    }

    .carousel-indicators [data-bs-target] {
        background-color: #ff0000;
        /* Indicadores rojos como tu tema */
        height: 5px;
        border-radius: 2px;
    }
    ...
    .list-group-item.active {
        background: linear-gradient(45deg, #d00000, #ff4d4d) !important;
        ...
        <div class="glass mb-4 carousel-container">
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-indicators">
                    <?php 
            $grupos = array_chunk($equipos, 4); // Agrupamos de a 4 logos por slide
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item <?= $i == 0 ? 'active' : '' ?>">
                        <div class="d-flex justify-content-center align-items-center mb-5">
                            ...
                            <img src="<?= $eq['log_url'] ?>" class="img-carousel"
                                alt="Logo de <?= htmlspecialchars($eq['nombre']) ?>">
                            <?php endforeach; ?>
                        </div>
                    </div>
                    <?php endforeach; ?>
        ...
        <div class="row">
                ...
                <div class="glass">
                    ...
                    <div class="list-group">
                        ...
                        <button class="list-group-item list-group-item-action btn-equipo"
                            ...
                            data-apodo="<?= htmlspecialchars($eq['apodo']) ?>"
                            data-dt="<?= htmlspecialchars($eq['dt_nom'].' '.$eq['dt_ape']) ?>"
                            data-est="<?= htmlspecialchars($eq['est_nom']) ?>" data-img="<?= $eq['uni_url'] ?>"
                            data-logo="<?= $eq['log_url'] ?>">
                            <i class="bi bi-shield-shaded me-2"></i> <?= htmlspecialchars($eq['nombre']) ?>
                        </button>
                        <?php endforeach; ?>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div id="msg-espera" class="glass p-5 text-center">
                    <img src="https://web.archive.org/web/20091024032410/http://geocities.com/SoHo/Museum/2034/under_construction.gif"
                        class="mb-3" alt="Cargando">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="d-flex align-items-center mb-3">
                                <img id="view-logo" src="" width="60" class="me-3 bg-white rounded-circle p-1"
                                    alt="Logo">
                                <h2 id="view-nombre" class="m-0 fw-bold"></h2>
                            </div>
                            <hr>
                            <p><i class="bi bi-chat-quote-fill text-danger"></i> <strong>APODO:</strong> <span
                                    id="view-apodo"></span></p>
                            <p><i class="bi bi-person-fill text-danger"></i> <strong>D.T.:</strong> <span
                                    id="view-dt"></span></p>
                            <p><i class="bi bi-geo-alt-fill text-danger"></i> <strong>ESTADIO:</strong> <span
                                    id="view-est"></span></p>
                        </div>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        botones.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('view-apodo').innerText = this.dataset.apodo ||
                    'Sin datos';
